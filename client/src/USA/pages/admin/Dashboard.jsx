  ...
  return (
    <div>
      <div className="mb-8 flex justify-between items-end">
        <div>
          <h1 className="text-3xl font-bold text-white mb-2">Us Dashboard</h1>
          <p className="text-gray-400">Portal overview and statistics for USA.</p>
        </div>
        <Link to="/USA/TDNG_Admin/articles" className="bg-primary hover:bg-primary-hover text-white px-4 py-2 rounded-lg flex items-center gap-2 font-medium transition-colors">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
        ...
        <StatCard
          ...
          link="/USA/TDNG_Admin/categories"
        />
        <StatCard
          title="Hero Sliders"
          value={stats.heroes}
          ...
          link="/USA/TDNG_Admin/heroes"
        />
      </div>

      <div className="bg-[#121212] border border-white/5 rounded-xl p-8">
        <h2 className="text-xl font-bold text-white mb-4">USA Portal Quick Guide</h2>
        <div className="space-y-4 text-gray-400">
          ...
          <p><span className="text-primary font-bold">2. Hero Sliders:</span> Use high-resolution images for the homepage slider to ensure a premium visual experience for USA visitors.</p>
          <p><span className="text-primary font-bold">3. Image Uploads:</span> All media is optimized and hosted via Cloudinary for maximum performance across USA.</p>
        </div>
      </div>
    </div>
  );
