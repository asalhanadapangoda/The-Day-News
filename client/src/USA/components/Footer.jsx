      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <Link to="/USA" className="inline-block">
              <img
                src={logo}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/USA" className="text-gray-400 hover:text-primary text-sm transition-colors">Home</Link></li>
              <li><Link to="/USA/articles" className="text-gray-400 hover:text-primary text-sm transition-colors">Articles</Link></li>
              <li><Link to="/USA/about" className="text-gray-400 hover:text-primary text-sm transition-colors">About Us</Link></li>
              <li><Link to="/USA/contact" className="text-gray-400 hover:text-primary text-sm transition-colors">Contact</Link></li>
            </ul>
          </div>
