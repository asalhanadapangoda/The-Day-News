  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-white mb-2">Homepage Hero Sliders (NZ)</h1>
          <p className="text-gray-400">Manage the rotating featured slider on the NZ homepage.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {heroes.length === 0 && (
          <div className="col-span-full text-center py-20 bg-[#121212] rounded-xl border border-white/5 text-gray-500">
            No hero slides found for SouthAfrica. Add one to appear on the homepage!
          </div>
        )}
      </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="p-6 overflow-y-auto space-y-4">
              ...
              <div>
                ...
                <input 
                  {...register("linkUrl")}
                  className="w-full bg-white/5 border border-white/10 text-white rounded-lg px-4 py-2 focus:border-primary focus:outline-none"
                  placeholder="/SouthAfrica/articles/slug"
                />
              </div>
