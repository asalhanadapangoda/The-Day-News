        ...
        <div className="glass-card p-8 md:p-12 mb-20 relative overflow-hidden">
          ...
          <div className="space-y-6 text-gray-300 leading-relaxed text-lg">
            <p>
              ...
              Our USA portal empowers a local and global audience to gain meaningful insights through active engagement with diverse perspectives from USA.
            </p>
            <p>
        ...
        <div className="mb-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Delivering trusted news and insights across continents — connecting communities from USA to around the world.
            </p>
          </div>
