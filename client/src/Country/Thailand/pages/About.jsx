...
const About = () => {
  return (
    <div className="w-full">
      <SEO 
        title="About Us | THE DAY NEWS THAILAND" 
        description="Learn about The Day News Thailand portal, newsroom mission, and reporting in Thailand."
        keywords="about us, Thailand news, the day news thailand, bangkok newsroom, mission"
      />
      {/* Hero */}
        ...
        <div className="glass-card p-8 md:p-12 mb-20 relative overflow-hidden">
          ...
          <div className="space-y-6 text-gray-300 leading-relaxed text-lg">
            <p>
              ...
              Our Thailand portal empowers a local and global audience to gain meaningful insights through active engagement with diverse perspectives from Thailand.
            </p>
            <p>
        ...
        <div className="mb-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Delivering trusted news and insights across continents — connecting communities from Thailand to around the world.
            </p>
          </div>
