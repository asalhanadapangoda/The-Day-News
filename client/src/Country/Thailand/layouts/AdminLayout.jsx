...
const AdminLayout = () => {
  ...
  const handleLogout = () => {
    logout();
    navigate('/Thailand/TDNG_Admin/login');
  };
  ...
  if (!admin) {
    return <Navigate to="/Thailand/TDNG_Admin/login" replace />;
  }

  const navLinks = [
    { name: 'Dashboard', path: '/Thailand/TDNG_Admin/dashboard', icon: LayoutDashboard },
    { name: 'Articles', path: '/Thailand/TDNG_Admin/articles', icon: FileText },
    { name: 'Categories', path: '/Thailand/TDNG_Admin/categories', icon: Layers },
    { name: 'Hero Sliders', path: '/Thailand/TDNG_Admin/heroes', icon: Monitor },
  ];
    ...
    <div className="flex min-h-screen bg-gray-900 text-white">
      ...
      <aside className="w-64 admin-sidebar flex flex-col">
        <div className="p-6 border-b border-white/5">
          <Link to="/Thailand/TDNG_Admin/dashboard" className="block text-center flex flex-col items-center justify-center">
