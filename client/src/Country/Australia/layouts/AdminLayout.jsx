...
import { LogOut, LayoutDashboard, Video, FileText, Layers, Image, Monitor } from 'lucide-react';
...
const AdminLayout = () => {
  ...
  const handleLogout = () => {
    logout();
    navigate('/Australia/TDNG_Admin/login');
  };
  ...
  if (!admin) {
    return <Navigate to="/Australia/TDNG_Admin/login" replace />;
  }

  const navLinks = [
    { name: 'Dashboard', path: '/Australia/TDNG_Admin/dashboard', icon: LayoutDashboard },
    { name: 'Programs', path: '/Australia/TDNG_Admin/programs', icon: Video },
    { name: 'Episodes', path: '/Australia/TDNG_Admin/episodes', icon: Image },
    { name: 'Articles', path: '/Australia/TDNG_Admin/articles', icon: FileText },
    { name: 'Categories', path: '/Australia/TDNG_Admin/categories', icon: Layers },
    { name: 'Hero Sliders', path: '/Australia/TDNG_Admin/heroes', icon: Monitor },
  ];
    ...
    <div className="flex h-screen overflow-hidden bg-gray-900 text-white">
      ...
      <aside className="w-64 admin-sidebar flex flex-col h-screen sticky top-0 shrink-0 overflow-y-auto">
        <div className="p-6 border-b border-white/5">
          <Link to="/Australia/TDNG_Admin/dashboard" className="block text-center flex flex-col items-center justify-center">
