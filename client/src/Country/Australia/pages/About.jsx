...
const About = () => {
  return (
    <div className="w-full">
      <SEO 
        title="About Us | THE DAY NEWS AUSTRALIA" 
        description="Learn about The Day News Australia, our coverage of Australian current affairs, and local journalism network."
        keywords="about us, Australia news, the day news australia, Sydney journalism, mission"
      />
      {/* Hero */}
