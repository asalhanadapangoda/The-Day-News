...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        const [programs, episodes, articles, categories, heroes] = await Promise.all([
          api.get('/programs'),
          api.get('/episodes'),
          api.get('/articles'),
          api.get('/categories'),
  ...
  return (
    <div>
      <div className="mb-8 flex justify-between items-end">
        ...
        <Link to="/Australia/TDNG_Admin/articles" className="bg-primary hover:bg-primary-hover text-white px-4 py-2 rounded-lg flex items-center gap-2 font-medium transition-colors">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
        <StatCard
          ...
          link="/Australia/TDNG_Admin/programs"
        />
        <StatCard
          title="Episodes"
          ...
          link="/Australia/TDNG_Admin/episodes"
        />
        <StatCard
          title="Articles"
          ...
          link="/Australia/TDNG_Admin/articles"
        />
        <StatCard
          ...
          link="/Australia/TDNG_Admin/categories"
        />
        <StatCard
          title="Hero Sliders"
          value={stats.heroes}
          ...
          link="/Australia/TDNG_Admin/heroes"
        />
      </div>
