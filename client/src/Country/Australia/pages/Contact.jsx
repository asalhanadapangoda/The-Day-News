...
const Contact = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      // Use globalApi so messages go to the root admin messages instead of Australia admin
      await globalApi.post('/messages', data);
  ...
  return (
    <div className="w-full">
      <SEO 
        title="Contact Us | THE DAY NEWS AUSTRALIA" 
        description="Contact The Day News Australia newsroom and editorial office."
        keywords="contact us, Australia newsroom, the day news australia, press contact, feedback"
      />
