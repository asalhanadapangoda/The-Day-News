...
const AdminLayout = () => {
  ...
  const handleLogout = () => {
    logout();
    navigate('/India/TDNG_Admin/login');
  };
  ...
  if (!admin) {
    return <Navigate to="/India/TDNG_Admin/login" replace />;
  }

  const navLinks = [
    { name: 'Dashboard', path: '/India/TDNG_Admin/dashboard', icon: LayoutDashboard },
    { name: 'Articles', path: '/India/TDNG_Admin/articles', icon: FileText },
    { name: 'Categories', path: '/India/TDNG_Admin/categories', icon: Layers },
    { name: 'Hero Sliders', path: '/India/TDNG_Admin/heroes', icon: Monitor },
  ];
    ...
    <div className="flex h-screen overflow-hidden bg-gray-900 text-white">
      ...
      <aside className="w-64 admin-sidebar flex flex-col h-screen sticky top-0 shrink-0 overflow-y-auto">
        <div className="p-6 border-b border-white/5">
          <Link to="/India/TDNG_Admin/dashboard" className="block text-center flex flex-col items-center justify-center">
