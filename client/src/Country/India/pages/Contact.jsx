...
const Contact = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      await globalApi.post('/messages', { ...data, origin: 'India' });
  ...
  return (
    <div className="w-full">
      <SEO 
        title="Contact Us | THE DAY NEWS INDIA" 
        description="Contact The Day News India newsroom and editorial office."
        keywords="contact us, India newsroom, the day news india, press contact, feedback"
      />
      <div className="bg-[#0c0014] py-16 border-b border-white/10 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl text-gray-400">Get in touch with The Day News Global - India Portal.</p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-10 leading-relaxed">
              Whether you have a news tip from India, a question about our coverage, or inquiries regarding partnerships in India, our team is ready to respond.
            </p>
