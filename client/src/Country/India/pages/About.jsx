...
const About = () => {
  return (
    <div className="w-full">
      <SEO 
        title="About Us | THE DAY NEWS INDIA" 
        description="Learn about The Day News India portal, our newsroom mission, and dedicated reporting across India."
        keywords="about us, India news, the day news india, delhi newsroom, mission"
      />
      {/* Hero */}
        ...
        <div className="glass-card p-8 md:p-12 mb-20 relative overflow-hidden">
          ...
          <div className="space-y-6 text-gray-300 leading-relaxed text-lg">
            <p>
              ...
              Our India portal empowers a local and global audience to gain meaningful insights through active engagement with diverse perspectives from India.
            </p>
            <p>
        ...
        <div className="mb-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Delivering trusted news and insights across continents — connecting communities from India to around the world.
            </p>
          </div>
