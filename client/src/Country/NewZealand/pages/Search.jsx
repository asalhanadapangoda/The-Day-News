...
const Search = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12 min-h-[70vh]">
      <SEO 
        title={query ? `Search: "${query}" | THE DAY NEWS NEW ZEALAND` : 'Search News | THE DAY NEWS NEW ZEALAND'}
        description={query ? `Search results for "${query}" on The Day News New Zealand.` : 'Search for news articles and stories in New Zealand.'}
        keywords={`search, ${query ? query + ', ' : ''}new zealand news search, articles, the day news new zealand`}
      />
