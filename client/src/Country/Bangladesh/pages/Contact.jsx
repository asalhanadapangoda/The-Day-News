...
const Contact = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      // Use globalApi so messages go to the root admin messages instead of Bangladesh admin
  ...
  return (
    <div className="w-full">
      <SEO 
        title="Contact Us | THE DAY NEWS BANGLADESH" 
        description="Contact The Day News Bangladesh newsroom and editorial office."
        keywords="contact us, bangladesh newsroom, the day news bangladesh, press contact, feedback"
      />
