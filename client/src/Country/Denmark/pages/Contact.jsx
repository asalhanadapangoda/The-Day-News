...
const Contact = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      await globalApi.post('/messages', { ...data, origin: 'Denmark' });
  ...
  return (
    <div className="w-full">
      <SEO 
        title="Contact Us | THE DAY NEWS DENMARK" 
        description="Get in touch with The Day News Denmark newsroom."
        keywords="contact us, Denmark newsroom, the day news denmark, press contact, feedback"
      />
      <div className="bg-[#0c0014] py-16 border-b border-white/10 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl text-gray-400">Get in touch with The Day News Global - Denmark Portal.</p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-10 leading-relaxed">
              Whether you have a news tip from Denmark, a question about our coverage, or inquiries regarding partnerships in Denmark, our team is ready to respond.
            </p>
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-6 bg-[#1a1a1a] p-6 rounded-xl border border-white/5">
                ...
                <div>
                  ...
                  <p className="text-primary hover:underline cursor-pointer">contact@thedaynewsglobal.lk</p>
                </div>
              </div>
