    ...
    <div>
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-gray-400">Written news and editorial features for Denmark.</p>
        </div>
        ...
        <table className="w-full text-left">
          ...
          <tbody className="divide-y divide-white/5">
            ...
            {filteredArticles.length === 0 && (
              <tr>
                <td colSpan="6" className="px-6 py-8 text-center text-gray-500">No articles found for Denmark matching your criteria.</td>
              </tr>
            )}
          </tbody>
        </table>
