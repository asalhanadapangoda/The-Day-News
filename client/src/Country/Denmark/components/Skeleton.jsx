    ...
    return (
      <div className="animate-pulse">
        ...
        <div className="max-w-4xl mx-auto px-4 -mt-32 relative z-10">
          <div className="h-8 bg-primary/20 rounded w-24 mb-6"></div>
          <div className="h-12 md:h-20 bg-white/10 rounded w-full mb-6"></div>
          <div className="h-6 bg-white/5 rounded w-3/4 mb-10"></div>
