...
const About = () => {
  return (
    <div className="w-full">
      <SEO 
        title="About Us | THE DAY NEWS JAPAN" 
        description="Learn about The Day News Japan, our newsroom mission, and coverage of Japanese news."
        keywords="about us, Japan news, the day news japan, tokyo newsroom, mission"
      />
      {/* Hero */}
        ...
        <div className="glass-card p-8 md:p-12 mb-20 relative overflow-hidden">
          ...
          <div className="space-y-6 text-gray-300 leading-relaxed text-lg">
            <p>
              ...
              Our Japan portal empowers a local and global audience to gain meaningful insights through active engagement with diverse perspectives from Japan.
            </p>
            <p>
        ...
        <div className="mb-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Delivering trusted news and insights across continents — connecting communities from Japan to around the world.
            </p>
          </div>
