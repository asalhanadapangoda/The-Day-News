...
const AdminLayout = () => {
  ...
  const handleLogout = () => {
    logout();
    navigate('/Japan/TDNG_Admin/login');
  };
  ...
  if (!admin) {
    return <Navigate to="/Japan/TDNG_Admin/login" replace />;
  }

  const navLinks = [
    { name: 'Dashboard', path: '/Japan/TDNG_Admin/dashboard', icon: LayoutDashboard },
    { name: 'Articles', path: '/Japan/TDNG_Admin/articles', icon: FileText },
    { name: 'Categories', path: '/Japan/TDNG_Admin/categories', icon: Layers },
    { name: 'Hero Sliders', path: '/Japan/TDNG_Admin/heroes', icon: Monitor },
  ];
    ...
    <div className="flex h-screen overflow-hidden bg-gray-900 text-white">
      ...
      <aside className="w-64 admin-sidebar flex flex-col h-screen sticky top-0 shrink-0 overflow-y-auto">
        <div className="p-6 border-b border-white/5">
          <Link to="/Japan/TDNG_Admin/dashboard" className="block text-center flex flex-col items-center justify-center">
