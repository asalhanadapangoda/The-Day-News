    ...
    <div>
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-400">Classifications for NZ Articles.</p>
        </div>
        <button 
      ...
      <div className="bg-[#121212] border border-white/5 rounded-xl overflow-hidden">
        <table className="w-full text-left">
          ...
          <tbody className="divide-y divide-white/5">
            ...
            {categories.length === 0 && (
              <tr>
                <td colSpan="4" className="px-6 py-8 text-center text-gray-500">No categories found for SouthAfrica.</td>
              </tr>
            )}
          </tbody>
        </table>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="p-6">
              <div className="mb-6">
                ...
                <input 
                  ...
                  placeholder="e.g. SouthAfrica News"
                />
