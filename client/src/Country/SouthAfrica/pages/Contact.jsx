...
const Contact = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      await globalApi.post('/messages', { ...data, origin: 'SouthAfrica' });
  ...
  return (
    <div className="w-full">
      <SEO 
        title="Contact Us | THE DAY NEWS SOUTH AFRICA" 
        description="Contact The Day News South Africa newsroom and editorial office."
        keywords="contact us, South Africa newsroom, the day news south africa, press contact, feedback"
      />
      <div className="bg-[#0c0014] py-16 border-b border-white/10 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl text-gray-400">Get in touch with The Day News Global - SouthAfrica Portal.</p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-10 leading-relaxed">
              Whether you have a news tip from SouthAfrica, a question about our coverage, or inquiries regarding partnerships in SouthAfrica, our team is ready to respond.
            </p>
