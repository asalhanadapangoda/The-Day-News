...
const AdminLayout = () => {
  ...
  const handleLogout = () => {
    logout();
    navigate('/SouthAfrica/TDNG_Admin/login');
  };
  ...
  if (!admin) {
    return <Navigate to="/SouthAfrica/TDNG_Admin/login" replace />;
  }

  const navLinks = [
    { name: 'Dashboard', path: '/SouthAfrica/TDNG_Admin/dashboard', icon: LayoutDashboard },
    { name: 'Articles', path: '/SouthAfrica/TDNG_Admin/articles', icon: FileText },
    { name: 'Categories', path: '/SouthAfrica/TDNG_Admin/categories', icon: Layers },
    { name: 'Hero Sliders', path: '/SouthAfrica/TDNG_Admin/heroes', icon: Monitor },
  ];
