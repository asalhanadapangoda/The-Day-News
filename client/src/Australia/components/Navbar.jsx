...
const Navbar = () => {
  ...
  const handleSearch = (e) => {
    e.preventDefault();
    if (searchQuery.trim()) {
      navigate(`/Australia/search?q=${encodeURIComponent(searchQuery)}`);
      setSearchQuery('');
      setIsMenuOpen(false);
    }
  };
  ...
  const navLinks = [
    { name: 'Home', path: '/Australia' },
    { name: 'Programs', path: '/Australia/programs' },
    { name: 'Articles', path: '/Australia/articles' },
    { name: 'About Us', path: '/Australia/about' },
    { name: 'Contact', path: '/Australia/contact' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex-shrink-0 flex items-center">
            <Link to="/Australia" className="flex items-center">
