  ...
  return (
    <div>
      <div className="mb-8 flex justify-between items-end">
        ...
        <Link to="/Bangladesh/TDNG_Admin/articles" className="bg-primary hover:bg-primary-hover text-white px-4 py-2 rounded-lg flex items-center gap-2 font-medium transition-colors">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
        <StatCard
          ...
          link="/Bangladesh/TDNG_Admin/programs"
        />
        <StatCard
          title="Episodes"
          ...
          link="/Bangladesh/TDNG_Admin/episodes"
        />
        <StatCard
          title="Articles"
          ...
          link="/Bangladesh/TDNG_Admin/articles"
        />
        <StatCard
          ...
          link="/Bangladesh/TDNG_Admin/categories"
        />
        <StatCard
          ...
          link="/Bangladesh/TDNG_Admin/ads"
        />
        <StatCard
          ...
          link="/Bangladesh/TDNG_Admin/messages"
        />
      </div>
