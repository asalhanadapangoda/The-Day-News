    ...
    <div className="w-full">
      ...
      <section className="max-w-7xl mx-auto px-4 py-12">
        <div className="flex justify-between items-end mb-10 border-b border-white/10 pb-4">
          ...
          <Link to="/Bangladesh/articles" className="text-primary hover:text-white transition-colors flex items-center gap-1 text-sm uppercase tracking-wider font-semibold">
      ...
      <section className="bg-black/20 backdrop-blur-sm py-16 border-y border-white/5 mt-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-end mb-8 border-b border-white/10 pb-4">
            ...
            <Link to="/Bangladesh/programs" className="text-primary hover:text-white transition-colors flex items-center gap-1 text-sm uppercase tracking-wider font-semibold">
