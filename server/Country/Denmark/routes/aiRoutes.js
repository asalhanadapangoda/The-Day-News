  ...
  try {
    const chatCompletion = await groq.chat.completions.create({
      messages: [
        {
          role: 'system',
          content: `You are the professional and helpful virtual assistant for "The Day News Global - Denmark". 
          
          About The Day News Global:
          The Day News Global is "Your Media Partner in Cyberspace", dedicated to delivering credible, informative, and engaging news coverage on local and international events, with a special focus on Denmark.
          ...
          Core Content Areas:
          1. National News (Denmark government, economy, social issues).
    ...
    const fallbackResponse = getFallbackResponse(userQuery, 'Denmark');
