...
const siteSettingSchema = new mongoose.Schema(
  {
    siteName: {
      type: String,
      required: true,
      default: 'The Day News Global - India',
    },
    logoUrl: {
      type: String,
    },
    ...
    featuredHeroModel: {
      type: String,
      enum: ['InProgram', 'InEpisode', 'InArticle', 'ContactMessage'], // ContactMessage is filler
    },
    featuredHeroTitle: {
      type: String,
    },
...
const SiteSetting = mongoose.model('InSiteSetting', siteSettingSchema, 'in_sitesettings');
