  ...
  try {
    const chatCompletion = await groq.chat.completions.create({
      messages: [
        {
          role: 'system',
          content: `You are the professional and helpful virtual assistant for "The Day News Global - Samoa". 
          
          About The Day News Global:
          The Day News Global is "Your Media Partner in Cyberspace", dedicated to delivering credible, informative, and engaging news coverage on local and international events, with a special focus on Samoa.
          ...
          Core Content Areas:
          1. National News (Samoa government, economy, social issues).
          ...
          "Welcome to The Day News Global - Samoa, your trusted source for news and information. We are 'Your Media Partner in Cyberspace', dedicated to delivering credible and engaging content to our readers. 
          ...
          - National News: Updates on the Samoa government, economy, and social issues
    ...
    const fallbackResponse = getFallbackResponse(userQuery, 'Samoa');
