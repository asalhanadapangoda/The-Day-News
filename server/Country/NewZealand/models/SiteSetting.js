...
const siteSettingSchema = new mongoose.Schema(
  {
    siteName: {
      type: String,
      required: true,
      default: 'The Day News Global - New Zealand',
    },
    logoUrl: {
      type: String,
    },
    ...
    contactEmail: {
      type: String,
      default: 'contact@thedaynewsglobal.lk',
    },
    contactPhone: {
      type: String,
    },
    ...
    featuredHeroModel: {
      type: String,
      enum: ['NzProgram', 'NzEpisode', 'NzArticle', 'ContactMessage'], // ContactMessage is filler
    },
    featuredHeroTitle: {
      type: String,
    },
...
const SiteSetting = mongoose.model('NzSiteSetting', siteSettingSchema, 'nz_sitesettings');
