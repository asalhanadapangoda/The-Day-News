...
const siteSettingSchema = new mongoose.Schema(
  {
    siteName: {
      type: String,
      required: true,
      default: 'The Day News Global - Samoa',
    },
    logoUrl: {
      type: String,
    },
    ...
    featuredHeroModel: {
      type: String,
      enum: ['SmProgram', 'SmEpisode', 'SmArticle', 'ContactMessage'], // ContactMessage is filler
    },
    featuredHeroTitle: {
      type: String,
    },
...
const SiteSetting = mongoose.model('SmSiteSetting', siteSettingSchema, 'sm_sitesettings');
