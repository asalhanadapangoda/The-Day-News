...
const siteSettingSchema = new mongoose.Schema(
  {
    ...
    featuredHeroModel: {
      type: String,
      enum: ['AuProgram', 'AuEpisode', 'AuArticle', 'ContactMessage'], // ContactMessage is filler
    },
    featuredHeroTitle: {
      type: String,
    },
...
const SiteSetting = mongoose.model('AuSiteSetting', siteSettingSchema, 'au_sitesettings');
