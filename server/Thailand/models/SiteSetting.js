...
const siteSettingSchema = new mongoose.Schema(
  {
    siteName: {
      type: String,
      required: true,
      default: 'The Day News Global - Thailand',
    },
    logoUrl: {
      type: String,
    },
    ...
    featuredHeroModel: {
      type: String,
      enum: ['ThProgram', 'ThEpisode', 'ThArticle', 'ContactMessage'], // ContactMessage is filler
    },
    featuredHeroTitle: {
      type: String,
    },
...
const SiteSetting = mongoose.model('ThSiteSetting', siteSettingSchema, 'th_sitesettings');
