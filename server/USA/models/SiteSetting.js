...
const siteSettingSchema = new mongoose.Schema(
  {
    siteName: {
      type: String,
      required: true,
      default: 'The Day News Global - USA',
    },
    logoUrl: {
      type: String,
    },
    ...
    featuredHeroModel: {
      type: String,
      enum: ['UsProgram', 'UsEpisode', 'UsArticle', 'ContactMessage'], // ContactMessage is filler
    },
    featuredHeroTitle: {
      type: String,
    },
...
const SiteSetting = mongoose.model('UsSiteSetting', siteSettingSchema, 'us_sitesettings');
